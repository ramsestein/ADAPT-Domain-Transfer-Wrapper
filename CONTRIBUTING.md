...
Tests live in `tests/` (regression tests) and `adapt/tests/` (unit tests).
...
2. Add a loader branch in `adapt_cli/model_loader.py` — follow the pattern of
   existing backends.
...
ADAPT follows [Semantic Versioning](https://semver.org).
